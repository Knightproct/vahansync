...
function LandingPage() {
  return <div className="landing-page"><header className="landing-header"><Brand /><nav><a href="#platform">Platform</a><a href="#roles">Roles</a><a href="#india">India-ready</a></nav><div><a className="text-link" href="/app">Sign in</a><a className="primary-button small" href="/signup">Create organisation</a></div></header><main><section className="landing-hero"><div className="landing-hero-copy"><span className="overline">Fleet operations, finally in sync</span><h1>Run every vehicle like it matters.</h1><p>VahanSync gives your team one live operating picture for readiness, maintenance, parts, compliance, safety, telematics, and finance.</p><div className="landing-actions"><a className="primary-button" href="/signup">Start your organisation →</a><a className="text-link" href="#platform">See how it works ↓</a></div><div className="proof-row"><span>14-day trial</span><span>7 role workspaces</span><span>Built for India</span></div></div><div className="hero-scene"><div className="hero-scene-glow" /><div className="hero-route"><span className="route-label">TODAY / OPERATIONS PULSE</span><div className="route-line"><i className="route-node node-start" /><span className="route-segment segment-done" /><i className="route-node node-live" /><span className="route-segment" /><i className="route-node node-alert" /><span className="route-segment" /><i className="route-node node-end" /></div><div className="route-stops"><span><b>24</b><small>vehicles moving</small></span><span><b>07</b><small>actions queued</small></span><span><b>03</b><small>risks ahead</small></span></div></div><div className="hero-float-card float-readiness"><span className="mini-icon">↗</span><div><small>Fleet readiness</small><strong>92%</strong></div><em>+8.4%</em></div><div className="hero-float-card float-work"><span className="mini-icon amber-icon">◌</span><div><small>Next handoff</small><strong>Workshop queue</strong></div><b>07</b></div><div className="hero-vehicle">V<span>AHAN</span><small>SYNC</small></div></div></section><section className="landing-proof"><span><b>01</b> See the next risk</span><span><b>02</b> Assign the right owner</span><span><b>03</b> Close the loop with evidence</span></section><section className="landing-section" id="platform"><div className="section-heading"><span className="overline">One connected platform</span><h2>From first signal to final sign-off.</h2><p>Every workspace is role-specific, but every action stays attached to the same operational record.</p></div><div className="feature-grid"><Feature number="01" title="See the signal" text="Vehicle identity, odometer, components, documents, and telematics expose the next risk." /><Feature number="02" title="Move the work" text="Fleet Managers dispatch. Technicians work. Drivers report. Inventory protects availability." /><Feature number="03" title="Prove the outcome" text="Accountants reconcile the rupee trail while owners retain governance and audit visibility." /></div></section><section className="role-band" id="roles"><div className="section-heading"><span className="overline">Every member, the right surface</span><h2>Responsibility without noise.</h2></div><div className="role-grid">{Object.entries(roleNames).map(([key, name], index) => <article key={key}><span>{String(index + 1).padStart(2, '0')}</span><strong>{name}</strong><p>{roleDescription(key)}</p></article>)}</div></section><section className="landing-section india-section" id="india"><div className="india-copy"><span className="overline">Built for Indian fleet realities</span><h2>Registration numbers, PUC, fitness, GST, FASTag, and paise-precise finance.</h2><p>Provider-neutral telematics and daily odometer sync keep the operating model ready for the way Indian transport businesses actually work.</p><a className="text-link" href="/signup">Build your workspace →</a></div><div className="india-grid"><span><b>₹</b><small>INR-native</small></span><span><b>24/7</b><small>operational visibility</small></span><span><b>1</b><small>source of truth</small></span><span><b>∞</b><small>members per plan</small></span></div></section></main><footer className="landing-footer"><Brand /><span>© 2026 VahanSync · Built for fleet operators in India</span><a className="text-link" href="/app">Sign in →</a></footer></div>
}
...
function Brand() { return <a className="brand" href="/"><img className="brand-mark" src="/vahansync-mark.svg" alt="" /><span><strong>VahanSync</strong><small>Fleet operating system</small></span></a> }
